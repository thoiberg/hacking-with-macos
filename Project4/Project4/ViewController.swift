...
extension NSTouchBarItem.Identifier {
    static let navigation = NSTouchBarItem.Identifier("thoiberg.project4.navigation")
    static let enterAddress = NSTouchBarItem.Identifier("thoiberg.project4.enterAddress")
    static let sharingPicker = NSTouchBarItem.Identifier("thoiberg.project4.sharingPicker")
    static let adjustGrid = NSTouchBarItem.Identifier("thoiberg.project4.adjustGrid")
    static let adjustRows = NSTouchBarItem.Identifier("thoiberg.project4.adjustRows")
    static let adjustCols = NSTouchBarItem.Identifier("thoiberg.project4.adjustCols")
}
...
class ViewController: NSViewController, WKNavigationDelegate, NSGestureRecognizerDelegate, NSTouchBarDelegate, NSSharingServicePickerTouchBarItemDelegate {
    ...
    override func makeTouchBar() -> NSTouchBar? {
        ...
        touchBar.customizationIdentifier = NSTouchBar.CustomizationIdentifier("thoiberg.project4")
        ...
        touchBar.customizationAllowedItemIdentifiers = [.sharingPicker, .adjustGrid, .adjustRows, .adjustCols]
